	...
	<div class="panel panel-default">
		...
		<div class="panel-body">
			...
			<div class="col-lg-12 edicionInformacion" style="display: none;">
				...
				<form role="form" id="frmEdicionEmpleado" commandName="empleadobean"
					style="width: 90%; padding-left: 10%;">
					<fieldset>
						<div class="col-lg-6">
							<!-- PRIMERA COLUMNA -->
							<div class="form-group" style="display: none">
								<label>Empleado</label> <input id="txtEmpleado"
									class="form-control" name="idEmpleado" placeholder="Empleado"></input>
						...
						<div class="col-lg-6">
							...
							<div class="form-group">
								<label> Cargo</label> <select class="form-control"
									id="comboCargo" name="idCargo">
								</select>
							</div>
							<div class="form-group">
								<label> Especialidad</label> <select class="form-control"
									id="comboEspecialidad" name="idEspecialidad">
								</select>
							</div>
							<div class="form-group">
								<label> Email</label>
							...
							<span class="btn btn-success"
								onclick="EditInformacionEmpleado();">Guardar</span> <span
